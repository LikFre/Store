			...
			<div class="container-fluid">
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						...
						<div class="item">
							<img src="${pageContext.request.contextPath}/img/ad/22.jpg">
							<div class="carousel-caption">

							</div>
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/img/ad/44.jpg">
							<div class="carousel-caption">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${news}" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath}/product/getproduct.do?pid=${p.pid}" style='color:#666'>${p.pname}</a></p>
