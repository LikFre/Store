		...
		<div class="container">
						  ...
						  <c:forEach items="${cart.cartItems}" var="item">
							<tr class="active">
								<td width="60" width="40%">
									<a href="${pageContext.request.contextPath}/product/getproduct.do?pid=${item.product.pid}">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/order/saveorder.do">
						<%--提交表单 --%>
...
$(function(){
	...
	$("#clear").click(function(){
		if(confirm("忍心删除我吗?")){
			location.href="${pageContext.request.contextPath}/cart/clearCart.do";
		}
	});
	...
	$(".delete").click(function(){
		var pid=this.title;
		if(confirm("忍心删除我吗?")){
			location.href="${pageContext.request.contextPath}/cart/deletecart.do?pid="+pid;
		}
	});
