...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" method="post" action="${pageContext.request.contextPath}/user/register.do">
			 <div class="form-group">
			    <label for="username" class="col-sm-2 control-label">用户名</label>
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="username" placeholder="请输入用户名" name="username" onblur="checkUser()">
...
$(function(){
	...
	$("#username").blur(function(){
		...
		var val=$(this).val();
		//alert(val);
		var vv=$.trim(val);//去掉左边与右边的空格
		if(vv!=""){
			//发送Ajax
			$.post("${pageContext.request.contextPath}/user/getByname.do",{"username":vv},function(dt){
				//alert(dt);
				if(dt=="true"){
