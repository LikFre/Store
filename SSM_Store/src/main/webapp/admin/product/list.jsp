...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/product_admintoAdd.action";
			}
		</script>
	</HEAD>
	<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp" method="post">
								...
								<c:forEach items="${page.list }" var="p" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/product_admintoEdit.action?pid=${p.pid}">
											...
											<td align="center" style="HEIGHT: 22px">
												<%--下架 pushdown --%>
												<a href="javascript:void(0);" class="delete" id="${p.pid }">
			...
			<jsp:include page="/WEB-INF/jsp/pageFile.jsp"></jsp:include>
		</form>
	</body>
	<script>
	$(function(){
		$(".delete").click(function(){
			var pid=this.id;
			if(confirm("确定下架？")){
				location.href="${pageContext.request.contextPath}/product_adminupdate.action?pflag=1&pid="+pid;
			}
		});
	});
