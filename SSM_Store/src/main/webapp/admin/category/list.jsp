...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addCategory(){
				window.location.href = "${pageContext.request.contextPath}/category_toaddcategory.action";
			}
		</script>
	</HEAD>
	<body>
								...
								<c:forEach items="${allCats}" var="c" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/category_toEditcategory.action?cid=${c.cid}">
													<img src="${pageContext.request.contextPath}/img/admin/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="javascript:void(0);" class="delete" id="${c.cid }">
	...
	$(function(){
		$(".delete").click(function(){
			var cid=this.id;
			if(confirm("确定删除?")){
				location.href="${pageContext.request.contextPath}/category_deletecategory.action?cid="+cid;
			}
		});
	});
